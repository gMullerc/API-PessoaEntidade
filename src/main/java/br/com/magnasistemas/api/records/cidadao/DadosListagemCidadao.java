...
public record DadosListagemCidadao(Long id, String nome, enumGenero genero, Endereco endereco, Contato contato, enumSituacaoEscolar situacaoEscolar, enumEscolaridade Escolaridade, Documento documentos) {
