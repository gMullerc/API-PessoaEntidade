...
public record DadosListagemCidadao(Long id, String nome, enumGenero genero, List<Endereco> endereco, Contato contato, enumSituacaoEscolar situacaoEscolar, enumEscolaridade Escolaridade, Documento documentos) {
